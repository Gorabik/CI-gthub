### Что нужно сделать:
Ваше домашнее задание на этот раз практически настоящее тестовое задание. 
Вы получите высокоуровневое описание сервиса - и ваше цель реализовать его по такому описанию. 
...
* Составьте полную документацию сервиса. Аннотируйте всё и опишите все модели. 
* Представьте, что вашего сервиса ждут фронтендеры. 
И им необходимо иметь максимально полное описание того, как работает бэкенд.
